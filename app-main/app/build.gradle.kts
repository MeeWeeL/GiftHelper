...
dependencies {
    ...
    implementation(project(":app-main:data:impl"))
    implementation(project(":app-main:domain:api"))
    implementation(project(":app-main:domain:impl"))
    implementation(project(":app-main:domain:models"))
    implementation(project(":app-main:features:menu"))
    implementation(project(":app-main:features:search"))
    implementation(project(":app-main:features:offer-new-gift"))
